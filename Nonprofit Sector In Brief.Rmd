...
```{r}
PC_2019_ExpenseGroup <- core2019pc %>% 
...
PC_2019_ExpenseGroup <- PC_2019_ExpenseGroup %>%
...
write.csv(table1.data, "Nonprofit_finance_2019.csv")
...
write.csv(PC_2019_ExpenseGroup, "Data/Output_Data/PC_2019_by_expense.csv")
```
