...
bmf2018 <- process_bmf(2018,12) %>% add_column(Year = "2018", .after="EIN")
bmf2017 <- process_bmf(2017,09) %>% add_column(Year = "2017", .after="EIN")       # for years that have multiple BMFs, I picked the earlier one 
...
```{r}
setwd(paste0("../../Functions/"));ls()
ls()
source(paste0("../../Functions/", "Process_core_file.R"))
source(paste0("../../", "Functions/","Process_core_file.R"))
# C:\Users\liu00\Downloads\Urban Internship\Nonprofit Sector In Brief\Functions
```
